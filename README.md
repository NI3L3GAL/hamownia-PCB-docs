...
┣ 📂 `references/` — Component datasheets, manuals, and application notes<br>
┣ 📜 `.gitignore` — Standard ignore rules for LaTeX builds and backups<br>
┣ 📜 `LICENSE` — Open-source license terms<br>
